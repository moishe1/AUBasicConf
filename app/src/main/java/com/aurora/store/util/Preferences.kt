...
object Preferences {
    ...
    const val PREFERENCE_WHITELIST_PASSWORD = "PREFERENCE_WHITELIST_PASSWORD"
    const val PREFERENCE_REMOTE_WHITELIST_URL = "PREFERENCE_REMOTE_WHITELIST_URL"
    const val PREFERENCE_REMOTE_WHITELIST_ENABLED = "PREFERENCE_REMOTE_WHITELIST_ENABLED"
    const val PREFERENCE_REMOTE_WHITELIST_LAST_UPDATE = "PREFERENCE_REMOTE_WHITELIST_LAST_UPDATE"
    const val PREFERENCE_DEVICE_PHONE_NUMBER = "PREFERENCE_DEVICE_PHONE_NUMBER"
